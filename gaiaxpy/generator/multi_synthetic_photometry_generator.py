...
class MultiSyntheticPhotometryGenerator(SyntheticPhotometryGenerator):
    ...
    def _generate(self, parsed_input_data, extension, output_file, output_format, save_file):
        ...
        # One list per system
        photometry_list_of_lists = [self._create_photometry_list(parsed_input_data, phot_system, sampled_basis_func, xp_merge) \
                                    for phot_system, sampled_basis_func, xp_merge in zip(photometric_system, sampled_basis_func_list, xp_merge_list)]
