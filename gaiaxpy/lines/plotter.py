...
def plot_spectra_with_lines(source_id, sampling, bpflux, rpflux, wavelength, flux, continuum, bplines, rplines, save_plots):
    ...
    elif len(rplines)>8: ax2.legend(fontsize=6)
    ...
    elif len(bplines+rplines)>12: ax3.legend(fontsize=4)
