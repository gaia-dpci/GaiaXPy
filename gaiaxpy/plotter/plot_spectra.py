...
def plot_spectra(spectra, sampling=None, multi=False, show_plot=True, save_path=None, file_name=None, format='png', legend=True):
    """"
    ...
    Args:
        ...
        save_path (str): Path to the directory where the figures will be saved. E.g.:
                         '/home/user/folder'
    ...
    if multi:
        if spectra_type == 'AbsoluteSampledSpectrum':
            plotter = MultiAbsolutePlotter(spectra, sampling, multi, show_plot, save_path, file_name, format, legend)
        elif spectra_type == 'XpSampledSpectrum':
            plotter = MultiXpPlotter(spectra, sampling, multi, show_plot, save_path, file_name, format, legend)
    else:
        plotter = SinglePlotter(spectra, sampling, multi, show_plot, save_path, file_name, format, legend)
    plotter._plot()

def _validate_input(spectra, sampling=None, multi=False, show_plot=True, save_path=None, file_name=None, format='png', legend=True):
