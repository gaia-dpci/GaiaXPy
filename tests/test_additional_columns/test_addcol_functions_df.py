...
class TestAddColDFGenerate(unittest.TestCase):
    ...
    def test_one_non_required_additional_col_as_dict(self):
    ...
    def test_more_than_one_non_required_additional_col_as_dict(self):
    ...
    def test_rename_mandatory_columns(self):
        additional_columns = {'bp_n_relevant_bases': 'source_id'}
        with pytest.raises(ValueError):
            generate(df, photometric_system=PhotometricSystem.Stromgren, additional_columns=additional_columns,
                     error_correction=False, save_file=False)
