...
from tests.files.paths import (cal_sol_default_sampling_path, sol_custom_sampling_path,
                               cal_sol_v211w_default_sampling_path, cal_sol_v211w_custom_sampling_path,
                               cal_sol_with_missing_sampling_path, cal_sol_with_covariance_sampling_path,
                               calibrator_sol_converters, cal_sol_default_path, cal_sol_custom_path,
                               cal_sol_v211w_default_path, cal_sol_v211w_custom_path, cal_sol_with_missing_path,
                               cal_sol_with_truncation_path)
...
solution_v211w_default_df = pd.read_csv(cal_sol_v211w_default_path, float_precision='round_trip',
                                        converters=calibrator_sol_converters)
solution_v211w_custom_df = pd.read_csv(cal_sol_v211w_custom_path, float_precision='round_trip',
                                       converters=calibrator_sol_converters)
# With missing
with_missing_solution_df = pd.read_csv(cal_sol_with_missing_path, float_precision='round_trip',
                                       converters=calibrator_sol_converters)
# Isolated missing
...
# With truncation
truncation_default_solution_df = pd.read_csv(cal_sol_with_truncation_path, float_precision='round_trip',
                                             converters=calibrator_sol_converters)
