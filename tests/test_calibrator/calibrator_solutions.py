...
from tests.files.paths import cal_sol_default_sampling_path, sol_custom_sampling_path, \
    cal_sol_v211w_default_sampling_path, \
    cal_sol_v211w_custom_sampling_path, cal_sol_with_missing_sampling_path, cal_sol_with_covariance_sampling_path, \
    calibrator_sol_converters, \
