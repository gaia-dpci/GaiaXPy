...
from tests.test_cholesky.cholesky_paths import mean_spectrum_csv_with_missing, inv_cov_with_missing_df, \
    isolated_missing_df
...
class TestCholeskyMissingBP(unittest.TestCase):
    ...
    def test_covariance_missing_bp(self):
        output_df = get_inverse_covariance_matrix(mean_spectrum_csv_with_missing)
    ...
    def test_get_chi2_values_missing_source_error(self):
        inv_sqrt_cov_df = get_inverse_square_root_covariance_matrix(mean_spectrum_csv_with_missing)
