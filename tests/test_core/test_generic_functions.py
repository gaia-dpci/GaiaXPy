...
from gaiaxpy.core import array_to_symmetric_matrix, _validate_pwl_sampling, \
                         _validate_wl_sampling, _validate_arguments, \
                         _get_system_label, _extract_systems_from_data
...
class TestValidatePwlSampling(unittest.TestCase):
...
class TestArrayToSymmetricMatrix(unittest.TestCase):
    ...
    def test_array_to_symmetric_matrix_wrong_tipe(self):
