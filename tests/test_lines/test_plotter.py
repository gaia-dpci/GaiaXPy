...
class TestPlotterMethod(unittest.TestCase):
    ...
    def test_plotter(self):
        ...
        rplines = [
            ('H_alpha', 15.73, 2, 15.65, 655.95, 8.1e-17, -2.1e-17, 14.19, 19.57, 1.02e-16, 34.20, 1154.83, 2.05)]
        save_plots = True
        f = plot_spectra_with_lines(source_id, sampling, bpflux, rpflux, wavelength, flux, continuum, bplines, rplines,
                                    save_plots)
