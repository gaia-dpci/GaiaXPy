...
class TestMultiAbsolute(unittest.TestCase):
    ...
    def test_multi_absolute_plotter(self):
        ...
        plot_spectra(mean_spectra, sampling=sampling, multi=True, show_plot=True, output_path=output_path,
    ...
    def test_multi_absolute_single_element(self):
        ...
        plot_spectra(mean_spectra.iloc[[0]], sampling=sampling, multi=True, show_plot=True, output_path=output_path,
                     output_file='multi_abs_with_legend_single', format='pdf', legend=True)
        plot_spectra(mean_spectra.iloc[[1]], sampling=sampling, multi=True, show_plot=True, output_path=output_path,
    ...
    def test_multi_absolute_range_elements(self):
        ...
        plot_spectra(aux_mean_spectra, sampling=sampling, multi=True, show_plot=True, output_path=output_path,
