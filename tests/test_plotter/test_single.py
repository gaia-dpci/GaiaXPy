...
class TestSingle(unittest.TestCase):
    ...
    def test_single_xp_plotter(self):
        ...
        plot_spectra(mean_spectra, sampling, multi=False, show_plot=True, output_path=output_path,
    ...
    def test_multi_xp_single_element(self):
        ...
        plot_spectra(mean_spectra.iloc[[0]], sampling, multi=False, show_plot=True, output_path=output_path,
                     output_file='single_xp_with_legend_element', format='pdf', legend=True)
        plot_spectra(mean_spectra.iloc[[1]], sampling, multi=False, show_plot=True, output_path=output_path,
