...
from gaiaxpy.simulator import get_file, load_config, _load_model_from_csv
...
class TestConfig(unittest.TestCase):
    ...
    def test_load_model_from_csv(self):
        loaded_config = _load_model_from_csv(model_config_file)
    ...
    def test_get_file(self):
        ...
        self.assertEqual(filename, path.join(config_path, f'MiogLite_{bp_model}{rp_model}.csv'))
